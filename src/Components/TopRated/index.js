...
class TopRated extends Component {
  // State can be directly declared without a constructor
  state = {
    details: null,
    isApiSuccess: false,
  }
  ...
  async componentDidMount() {
    const response = await fetch(
      'https://api.themoviedb.org/3/movie/top_rated?api_key=e798bc18470a0e1b233b117db0eed371&language=en-US&page=1',
    )
    if (response.ok) {
